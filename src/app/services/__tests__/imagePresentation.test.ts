...
describe('imagePresentation', () => {
  test('prefers the exact image link over a proxy preview when both are available', () => {
    const candidate = {
    ...
    expect(resolveCandidateImageSrc(candidate)).toBe('https://cdn.example.com/chapter-12/page-001.webp');
